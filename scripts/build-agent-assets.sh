...
# ---- rules files (AGENTS.md is the source; derive the rest) ----
cp "$ASSETS/AGENTS.md" "$AGENTOUT/AGENTS.md"

{
  echo "<!-- Claude Code auto-loads CLAUDE.md. These are the project's Hale rules. -->"
  echo ""
  sed '1s/^# AGENTS.md/# CLAUDE.md/' "$ASSETS/AGENTS.md"
} > "$AGENTOUT/CLAUDE.md"

# .cursorrules: same rules, retitled.
sed '1s/^# AGENTS.md — /# Cursor rules — /' "$ASSETS/AGENTS.md" > "$AGENTOUT/.cursorrules"
