...
One limit at v1: classes are single-seed. One declared in a given compilation seed does not resolve from another, because merging per-seed intern tables needs index remapping across the merged AST.
